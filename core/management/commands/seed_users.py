...
# usage first add the users and their role in user_data below
# Execute python manage.py seed_users --hospital-phone=(use the phone number of the hospital)
...
class Command(BaseSeedCommand):
    ...
    def seed(self):
        ...
        user_data = [
            # {"mobile_num": "9959223401", "role": "Reception"},
